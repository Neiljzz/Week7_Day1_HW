//==================Exercise #1 ==========//
/*
    Given an array of numbers 1 through 15, 
    loop through the array and log one of the following values for each number:
...
// for (let num of charArray){console.log(num)}
...
loop through them both individually and the sum all of the positives elements.
